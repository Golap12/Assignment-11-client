    ...
    return (
        <div className="container mx-auto py-8">
            <div className='flex flex-col justify-center items-center'>
                ...
                <p className="text-center text-sm text-gray-400 mb-8 w-9/12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 lg:px-20 gap-6">
                {foods.length > 0 ? (
                    foods.map((food) => (
                    ...
                    <div className="text-center text-white">No foods found</div>
                )}
            </div>
        </div>
    );
